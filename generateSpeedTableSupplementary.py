...
distributions=["ERR1050075_1.fastq", "SRR11551346.fastq", "SRR12801265.fastq", "SRR12924365.fastq", "SRR12937177.fastq", "ERR992657_2.fastq", "SRR12873993.fastq", "SRR12989394.fastq"]
...
for f in fprs:
    ...
    for d in distributions:
        ...
        numQueries=0
        for t in trials:
            filename=inputFolder+"speed.kmers.%s.s28.%s.%s"%(d,f,t)
